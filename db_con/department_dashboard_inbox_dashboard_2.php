    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td class='align-middle'>
                    <a href='../../../db_con/department_dashboard_inbox_dashboard_delete_2.php?id=".urlencode($row['id'])."' class='btn bg-gradient-primary btn-primary text-secondary2' onclick='return confirm(\"Are you sure you want to delete this List?\");'>
                        Delete
                    </a>
                </td>
              </tr>";
