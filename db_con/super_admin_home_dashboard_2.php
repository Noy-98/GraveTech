    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td class='align-middle'>
                    <a href='../../../db_con/super_admin_department_delete.php?email=".urlencode($row['email'])."' class='text-secondary2 font-weight-bold text-xs' onclick='return confirm(\"Are you sure you want to delete this guest?\");'>
                        Delete
                    </a>
                </td>
              </tr>";
