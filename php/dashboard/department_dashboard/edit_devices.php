      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Device Info Dashboard</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Edit Device Info Dashboard</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary backgroundColor shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Edit Device Info</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
            <div class="col-12 col-xl-12">
                <div class="card-body">
                    <form method="post" action="../../../db_con/department_dashboard_home_dashboard_edit.php">
