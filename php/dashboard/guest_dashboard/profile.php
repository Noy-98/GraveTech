...
$sql = "SELECT full_name, grave_name, grave_location, email, profile_pictures FROM guesttbl WHERE id = ?";
...
<head>
  ...
  <title>
  Garden of Memories | Guest Dashboard
  </title>
  <!--     Fonts and icons     -->
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <span class="ms-1 font-weight-bold text-white">Guest Dashboard</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white" href="../../../php/dashboard/guest_dashboard/home.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../../../php/dashboard/guest_dashboard/messages.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="../../../php/dashboard/guest_dashboard/profile.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../../../db_con/logout_con_2.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="../../../php/dashboard/guest_dashboard/profile.php" class="nav-link text-body font-weight-bold px-0">
      ...
      <div class="card card-body mx-3 mx-md-4 mt-n6">
        ...
        <div class="row">
          <div class="row">
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp; <?php echo htmlspecialchars($user_data['full_name']); ?> </li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Grave Name:</strong> &nbsp; <?php echo htmlspecialchars($user_data['grave_name']); ?> </li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Grave Location:</strong> &nbsp; <?php echo htmlspecialchars($user_data['grave_location']); ?> </li>
            ...
            <div class="col-12 col-xl-4">
                <div class="card-body">
                    <form method="post" action="../../../db_con/guest_dashboard_profile_dashboard.php">
                        <div class="input-group input-group-outline mb-3">
                        <label class="form-label">Full Name</label>
                        <input type="text" name="full_name" class="form-control">
                        </div>
                        <div class="input-group input-group-outline mb-3">
                        <label class="form-label">Grave Name</label>
                        <input type="text" name="grave_name" class="form-control">
                        </div>
                        <div class="input-group input-group-outline mb-3">
                        <label class="form-label">Grave Location</label>
                        <input type="text" name="grave_location" class="form-control">
                        </div>
                        <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="col-12 text-right">
                      <button type="button" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" id="uploadButton">Update Picture</button>
                        <form id="uploadForm" method="post" action="../../../db_con/guest_dashboard_update_profile_picture.php" enctype="multipart/form-data" style="display: none;">
