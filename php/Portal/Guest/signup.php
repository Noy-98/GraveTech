...
<body>
  ...
  <section id="login">
    <div class="center">
      ...
      <form method="post" action="../../../db_con/guest_signup_con.php">
        <div class="txt_field">
        ...
        <div class="txt_field">
          <input type="text" name="grave_name" required>
          <span></span>
          <label>Grave Name</label>
        </div>
        <div class="txt_field">
          <input type="text" name="grave_location" required>
          <span></span>
        ...
        <div class="signup_link">
          Have Account? <a href="../../../php/Portal/Guest/login.php">Login</a>
        </div>
      </form>
    </div>
  </section>
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        ...
        <div class="col-lg-4 col-md-12 footer-newsletter">
          ...
          <form action="../../../db_con/news_letter_3.php" method="post" class="php-email-form">
